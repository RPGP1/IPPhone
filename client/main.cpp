...
int main(int argc, char** argv)
{
    ...
    auto context = IPPhone::PulseAudio::Context::create(mainloop, "IPPhone_client");
    ...
    auto local_endpoint = IPPhone::TCP::get_local_connected_endpoint(io_service, peer_endpoint);
